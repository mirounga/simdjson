...
// kernel's lookup_16 (which uses haswell's native vpshufb gap fill) over the whole
// 64-byte block at once. The whitespace/op tables encode pshufb low-nibble lookups;
// the [ ]/{ } pair is folded with | 0x20 (see the table comments below).
