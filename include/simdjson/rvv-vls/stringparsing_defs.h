...
// (a half-block); no simd8 wrapper. Uses the kernel's free functions. (The old RVV
// SIMDJSON_SKIP_BACKSLASH_SHORT_CIRCUIT path is dropped in favor of the proven x86
// std::simd path.)
