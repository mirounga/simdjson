...
// (a half-block); no simd8 wrapper. Uses the kernel's free functions. (The old LASX
// simd8 to_bitmask + SIMDJSON_SKIP_BACKSLASH_SHORT_CIRCUIT are dropped in favor of
// the proven x86 std::simd path.)
