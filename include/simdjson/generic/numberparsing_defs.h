// Generic, ISA-agnostic number parsing helpers (portable SWAR; the compiler vectorizes at -march).
#ifndef SIMDJSON_GENERIC_NUMBERPARSING_DEFS_H
#define SIMDJSON_GENERIC_NUMBERPARSING_DEFS_H
...
#endif // SIMDJSON_GENERIC_NUMBERPARSING_DEFS_H
